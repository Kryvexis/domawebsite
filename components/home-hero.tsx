        ...
        <div className="section-shell relative z-10 grid w-full items-center gap-14 lg:grid-cols-[1.1fr_0.9fr]">
          <motion.div style={{ y: textY }}>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link href="/products" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-orange-500 px-6 py-4 font-semibold uppercase tracking-[0.12em] text-zinc-950 shadow-2xl shadow-orange-500/20 transition hover:bg-orange-400">
                Explore Products <ArrowRight className="h-4 w-4" />
              </Link>
              <Link href="/services" className="rounded-2xl border border-white/15 bg-white/5 px-6 py-4 font-semibold uppercase tracking-[0.12em] transition hover:bg-white/10">
                Trade Services
              </Link>
            </div>
