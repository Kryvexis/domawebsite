        ...
        <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="steel-panel rounded-[2rem] p-8">
              <div className="grid gap-4">
                {contactCards.map(({ label, value, Icon }) => (
                  <div key={label} className="flex items-center gap-4 rounded-2xl border border-white/10 bg-zinc-900/80 px-5 py-4">
          ...
          <Reveal>
            <div className="rounded-[2rem] border border-white/10 bg-gradient-to-b from-orange-500/10 to-white/5 p-8">
              ...
              <div className="mt-4 text-4xl font-black uppercase">A premium form section would sit here.</div>
