          ...
          {services.map((service) => {
            ...
            return (
              <Reveal key={service.title}>
                <div className="steel-panel min-h-[250px] rounded-[2rem] p-8 transition hover:-translate-y-1.5">
                  ...
                  <div className="text-3xl font-black">{service.title}</div>
                  <p className="mt-4 text-lg leading-relaxed text-zinc-300">{service.desc}</p>
                  <div className="mt-8 inline-flex items-center gap-2 font-semibold text-orange-300">
